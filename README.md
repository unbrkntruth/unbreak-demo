...
2. Unbreak posts a comment on the PR quoting the failing lines, and a check run with one button, **Unbreak this**.
...
4. CI goes green, and the comment and the check run show the report: tests before and after, regressions, every changed file with its reason, cost and time.
...
| [#1](https://github.com/unbrkntruth/unbreak-demo/pull/1) express 4.19.2 → 5.2.1 (recreated 2026-09-12) | Fixed: CI green, 0 regressions (18/18 before and after), $0.18 of API usage, 10 turns, 44 s | [check run](https://github.com/unbrkntruth/unbreak-demo/runs/103493244874) · [full report](https://github.com/unbrkntruth/unbreak-demo/actions/runs/34671385856) · fix commit [`fd5f3b3`](https://github.com/unbrkntruth/unbreak-demo/commit/fd5f3b3a301529342b5beeca94b5b8db48703ca4) · [PR comment](https://github.com/unbrkntruth/unbreak-demo/pull/1#issuecomment-5643264543) |
