...
/**
 * Normalises pagination params and publishes them on res.locals so downstream
 * handlers can trust them. req.query is a read-only getter on Express 5, so
 * writes back to it are silently lost.
 */
